  ...
  return (
    ...
    <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex justify-center space-x-8">
            <a href="mailto:support@crowdsprout.com" className="hover:scale-110 transition duration-300">
            ...
            <a href="https://twitter.com/CrowdSprout" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition duration-300">
            ...
            <a href="tel:+123456789" className="hover:scale-110 transition duration-300">
            ...
            <a href="https://instagram.com/CrowdSprout" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition duration-300">
