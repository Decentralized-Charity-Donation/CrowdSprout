...
const FundCard = ({ campaign, minContribution, campaignId, refreshCampaign }) => {
  const [donationAmount, setDonationAmount] = useState('');
  const { contract, signer, owner } = useContract();
  ...
  const handleDonate = async (e) => {
    ...
    try {
      ...
      setDonationAmount('');
      refreshCampaign(); 
      console.log(contract.getCampaignFinancialDetails(campaignId).goal)
    } catch (error) {
